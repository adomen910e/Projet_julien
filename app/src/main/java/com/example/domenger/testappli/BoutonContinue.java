...
public class BoutonContinue extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (scanningResult != null) {
            ...
            buttonChemin.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(BoutonContinue.this, BoutonItineraire.class);
            ...
            buttonPlan.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(BoutonContinue.this, BoutonPlan.class);
                    startActivity(intent);
                }
            });
